...
const MCFixupKindInfo &DPUAsmBackend::getFixupKindInfo(MCFixupKind Kind) const {
  static const MCFixupKindInfo Infos[DPU::NumTargetFixupKinds] = {
      ...
      {"FIXUP_DPU_IMM12", 0, 48, 0},
      {"FIXUP_DPU_IMM13_STR", 0, 48, 0},
      {"FIXUP_DPU_IMM16_STR", 0, 48, 0},
      {"FIXUP_DPU_IMM22", 0, 48, 0},
      {"FIXUP_DPU_IMM22_RB", 0, 48, 0},
      {"FIXUP_DPU_IMM24", 0, 48, 0},
      {"FIXUP_DPU_IMM32", 0, 48, 0},
      {"FIXUP_DPU_IMM32_DUS_RB", 0, 48, 0},
      {"FIXUP_DPU_IMM32_ZERO_RB", 0, 48, 0},
      {"FIXUP_DPU_IMM4", 0, 48, 0},
      {"FIXUP_DPU_IMM5", 0, 48, 0},
      {"FIXUP_DPU_IMM5_RB", 0, 48, 0},
      {"FIXUP_DPU_IMM5_RB_INV", 0, 48, 0},
      {"FIXUP_DPU_IMM8", 0, 48, 0},
      {"FIXUP_DPU_IMM8_DMA", 0, 48, 0},
      {"FIXUP_DPU_IMM8_STR", 0, 48, 0},
      {"FIXUP_DPU_PC", 0, 48, 0},
  };
