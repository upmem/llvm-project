...
static inline DPU::Fixups findFixupForOperand(unsigned OpNum,
  ...
  case DPU::SHrii:
    ...
    default:
      llvm_unreachable("invalid operand number");
    case 1:
      return DPU::Fixups::FIXUP_DPU_IMM13_STR;
    case 2:
